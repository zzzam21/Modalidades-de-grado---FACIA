    ...
    <div class="modal fade" id="userNameModal" tabindex="-1" aria-labelledby="userNameModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="<?= base_url("configuration/updateName") ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="passwordActualEmail" placeholder="*********">
                    </div>
                    <div class="mb-3">
                        <label for="passwordNewEmail" class="form-label">Nueva Contraseña</label>
                        <input type="password" class="form-control" id="passwordNewEmail" placeholder="********">
                    </div>
                    <div class="mb-3">
                        <label for="passwordConfirmEmail" class="form-label">Confirmar Contraseña</label>
                        <input type="password" class="form-control" id="passwordConfirmEmail" placeholder="********">    
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
